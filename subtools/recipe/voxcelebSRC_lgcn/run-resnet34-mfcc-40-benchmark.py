...
model_dir="exp/vox1_augx4_mfcc40_noise/extended_baseline/"
##--------------------------------------------------##
##
######################################################### START #########################################################
##
...
if stage <= 4 <= endstage and utils.is_main_training():
    ...
    prefix = "mfcc_40" # For to_extracted_data.

    to_extracted_positions = ["near"] # Define this w.r.t extracted_embedding param of model_blueprint.
    to_extracted_data = ["voxceleb1_train","voxceleb2_train"] # All dataset should be in data_root/prefix.
