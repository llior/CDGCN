...
import libs.egs.egs_new as egs
import libs.training.optim as optim
import libs.training.lr_scheduler_new as learn_rate_scheduler
import libs.training.trainer_new as trainer
...
amp_th=50
de_silence = True
vad_wav_savdir="/tsdata1/ldx/de_silence/voxceleb"
...
shard_dir='/work2/ldx/voxceleb_dev_vad50'
##--------------------------------------------------##
## Prepare speech augmention csv files.
pre_rirmusan = args.pre_rirmusan # whether skip this stage.
openrir_folder = "/tsdata/ASR"  # where contains RIRS_NOISES folder.
musan_folder = "/tsdata/ASR"    # where contains musan folder.
csv_aug_folder = "exp/aug_csv_0430"  # csv file location.
savewav_folder = "/work1/ldx/speech_aug_0430"  # save the noise seg into SSD.
...
traindata_for_egs = "data/raw/voxceleb2_dev_vad50"
egs_dir = "exp/egs_2080/voxceleb2_dev_vad50"
egs_conf="subtools/conf/egs_pre_sre.yaml"
model_blueprint = "subtools/pytorch/model/resnet_xvector.py"
model_dir = "exp/resnet34_fbank_81_shard_vad50"
##--------------------------------------------------##
##
#### Set seed
...
if stage <= 4 <= endstage and utils.is_main_training():
    ...
    to_extracted_data = ["voxceleb2_dev_vad50","voxceleb1"] # All dataset should be in dataroot/prefix.
    to_extracted_epochs = ["41"] # It is model's name, such as 10.params or final.params (suffix is w.r.t package).
