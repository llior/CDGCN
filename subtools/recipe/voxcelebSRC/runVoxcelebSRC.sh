...
subtools/makeFeatures.sh data/$prefix/voxceleb2_dev/ $feat_type $feat_conf
...
subtools/runPytorchLauncher.sh subtools/recipe/voxcelebSRC/run-resnet34-fbank-81-benchmark.py --stage=3 --endstage=3 --gpu-id=0
...
for task in $tasks;do
    ...
    subtools/recipe/voxcelebSRC/gather_results_from_epochs.sh --prefix $prefix --score cosine  --submean true \
         --vectordir "exp/resnet34_fbank_81_benchmark" --task $task --epochs "6" --positions "near" \
