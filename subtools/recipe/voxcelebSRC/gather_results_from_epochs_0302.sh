...
epochs="6"
positions="near"
vectordir="exp/vox2augx4spx3_fbank81_sequential/resnet34_se_am_no_norm"

task=
trials=
srcdata=voxceleb1_train_test
trainset=voxceleb2_train
enrollset=  #由subtools/split_enroll_test_by_trials.sh得到
testset=
...
top_n=100
cohort_set=voxceleb2_train # If not NULL, use provided set
score_norm_spk_mean=true

cohort_method="sub" # "sub" | "mean". It works when cohort_set is empty.
cohort_set_from=voxceleb2_train # Should be a subset of $trainset if use cohort_set_method.
...
for position in $positions;do
    ...
    for epoch in $epochs;do
        ...
        ./scoreSets_vox11108.sh  --prefix $prefix --score $score --vectordir $obj_dir --enrollset $enrollset --testset $testset \
        ...
        if [[ "$score_norm" == "true" && -f $obj_dir/$name.score ]];then
            ...
            ./scoreSets_vox11108.sh  --prefix $prefix --eval true --score $score --vectordir $obj_dir \
