...
function submean(){
	...
	ivector-subtract-global-mean $specifier:$infile ark:$outfile || exit 1
	return 0
}
...
function norm(){
	...
	ivector-normalize-length --scaleup=false $specifier:$infile ark:$outfile || exit 1
	return 0
}
