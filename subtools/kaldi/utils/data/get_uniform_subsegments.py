...
def get_args():
    parser = argparse.ArgumentParser(
        ...
        subtools/kaldi/utils/data/get_segments_for_data.sh to generate a 'default'
        ...
        subtools/kaldi/utils/data/subsegment_data_dir.sh data/dev \\
        ...
        passed to subtools/kaldi/utils/data/subsegment_data_dir.sh to sub-segment
        the data directory."""),
...
def run(args):
    ...
    for line in args.segments_file:
        ...
        start = start_time
        if start_time==6.829 and end_time==8.329:
            print("stop")
