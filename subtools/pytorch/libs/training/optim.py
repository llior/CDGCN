...
def get_optimizer(model, params:dict={}):
    ...
    if name == "sgd":
        ...
        base_optimizer = optim.SGD(chain(model.tdnn1.parameters(),model.tdnn2.parameters(),model.tdnn3.parameters(),model.tdnn4.parameters(),
        model.tdnn5.parameters(),model.tdnn6.parameters(),model.tdnn7.parameters(),model.ex_tdnn1.parameters(),
        model.ex_tdnn2.parameters(),model.ex_tdnn3.parameters(),model.ex_tdnn4.parameters(),model.ex_tdnn5.parameters(),
        model.stats.parameters(),model.loss.parameters(),model.loss2.parameters(),model.RFM.parameters()
                                        ), lr=learn_rate, momentum=beta1, weight_decay=weight_decay,nesterov=nesterov)
    elif name == "sgd_resnet_dal":
        base_optimizer = optim.SGD(chain(model.resnet.parameters(),model.stats.parameters(),model.fc2.parameters(), model.loss.parameters(),model.loss2.parameters(),model.RFM.parameters()
                                        ), lr=learn_rate, momentum=beta1, weight_decay=weight_decay,nesterov=nesterov)
    elif name == "sgdW":
        ...
        base_optimizer = AdamW(chain(model.tdnn1.parameters(),model.tdnn2.parameters(),model.tdnn3.parameters(),model.tdnn4.parameters(),
        model.tdnn5.parameters(),model.tdnn6.parameters(),model.tdnn7.parameters(),model.ex_tdnn1.parameters(),
        model.ex_tdnn2.parameters(),model.ex_tdnn3.parameters(),model.ex_tdnn4.parameters(),model.ex_tdnn5.parameters(),
       model.stats.parameters(),model.loss.parameters(),model.loss2.parameters(),model.RFM.parameters()
                                        ), lr=learn_rate, betas=(beta1, beta2), weight_decay=weight_decay, **extra_params)
    
    elif name == "adamW_dal_att":
        base_optimizer = AdamW(chain(model.tdnn1.parameters(),model.tdnn2.parameters(),model.tdnn3.parameters(),model.tdnn4.parameters(),
        model.tdnn5.parameters(),model.tdnn6.parameters(),model.tdnn7.parameters(),model.ex_tdnn1.parameters(),
        model.ex_tdnn2.parameters(),model.ex_tdnn3.parameters(),model.ex_tdnn4.parameters(),model.ex_tdnn5.parameters(),
       model.stats.parameters(),model.loss.parameters(),model.loss2.parameters(),model.att.parameters(),model.RFM.parameters()
                                        ), lr=learn_rate, betas=(beta1, beta2), weight_decay=weight_decay, **extra_params)

    elif name == "sgd_resnet_dal_att":
        base_optimizer = optim.SGD(chain(model.resnet.parameters(),model.stats.parameters(),model.fc2.parameters(), model.loss.parameters(),model.loss2.parameters(),
        model.att.parameters(),model.RFM.parameters() ), lr=learn_rate, momentum=beta1, weight_decay=weight_decay,nesterov=nesterov)
                                        
    elif name == "adamW_dal_gan":
        base_optimizer = AdamW(chain(model.tdnn1.parameters(),model.tdnn2.parameters(),model.tdnn3.parameters(),model.tdnn4.parameters(),
        model.tdnn5.parameters(),model.tdnn6.parameters(),model.tdnn7.parameters(),model.ex_tdnn1.parameters(),
        model.ex_tdnn2.parameters(),model.ex_tdnn3.parameters(),model.ex_tdnn4.parameters(),model.ex_tdnn5.parameters(),
       model.stats.parameters(),model.loss.parameters(),model.loss2.parameters()
                                        ), lr=learn_rate, betas=(beta1, beta2), weight_decay=weight_decay, **extra_params)
        ...
        base_optimizer = SWATS(model.parameters(), lr=learn_rate, betas=(beta1, beta2), weight_decay=weight_decay)
    else:
...
class SWATS(Optimizer):
    ...
    https://github.com/Mrpatekful/swats/blob/master/swats/optim.py
    """
