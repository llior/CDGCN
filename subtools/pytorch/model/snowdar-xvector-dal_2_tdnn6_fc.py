...
class Xvector(TopVirtualNnet):
    ...
    def init(self, inputs_dim, num_targets, extend=False, skip_connection=False, 
        ...
        # tdnn6_params = {"nonlinearity":"", "bn":False},
        tdnn6_params = utils.assign_params_dict(tdnn_layer_params, tdnn7_params)
        ...
        # Segment level
        if tdnn6:
            self.tdnn6 = ReluBatchNormTdnnLayer(stats_dim, 512, **tdnn6_params)
            tdnn7_dim = 512
        else:
            self.tdnn6 = None
            tdnn7_dim = stats_dim
        ...
        self.fc = ReluBatchNormTdnnLayer(tdnn7_dim,512, **tdnn7_params)
