...
class Xvector(TopVirtualNnet):
    ...
    def init(self, inputs_dim, num_targets, extend=False, skip_connection=False, 
             ...
             specaugment=False, specaugment_params={},chunk_dropout=False,chunk_dropout_params={},
        ...
        if training :
            if margin_loss:
                ...
                self.loss = MixupTrainLoss(512, num_targets,**margin_loss_params)
        ...
        # self.affine = TdnnAffine(512, num_targets)
    ...
    def forward(self, inputs):
        ...
        x = self.auto(self.chunk_dropout,x)
        # print(x.shape)
    ...
    @utils.for_device_free
    def get_loss(self, inputs, targets_1,z1=None,targets_2=None,z2=None,lam=None):
        ...
        if self.wrapper_loss is not None:
            return self.wrapper_loss( targets_1,z1,targets_2,z2,lam)
        else:
            return self.loss(inputs, targets_1,z1,targets_2,z2,lam)
    ...
    def get_posterior(self, inputs):
        # self.affine = TdnnAffine(512, num_targets)
        return self.loss.get_posterior(inputs)
