...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, Conv=nn.Conv2d, stride=1, downsample=None, groups=1,
        ...
        self.c2wh = dict([(32,112), (64,56), (128,28), (256,14) ,(512,7)])
    ...
    def _original(self, inplanes, planes, Conv, stride, norm_layer, norm_layer_params):
        ...
        self.se = MultiSpectralAttentionLayer(planes , self.c2wh[planes], self.c2wh[planes],  reduction=16, freq_sel_method = 'top16')
