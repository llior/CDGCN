...
class XMU_TDNN(TopVirtualNnet):
    def init(self, inputs_dim, num_targets, channels=512, embd_dim=512, 
             aug_dropout=0., tail_dropout=0., training=True,
             extracted_embedding="far", mixup=False, mixup_alpha=1.0,
             pooling="ecpa-attentive", pooling_params={}, fc1=True, fc1_params={}, fc2_params={},
        ...
        if fc1:
            ...
            self.fc1 = nn.Linear(cat_channels * 2, embd_dim)
            self.bn1 = nn.BatchNorm1d(embd_dim)
            fc2_in_dim = embd_dim
        else:
            fc2_in_dim = cat_channels * 2
        
        self.fc2 = nn.Linear(fc2_in_dim, embd_dim)
        ...
        if training :
            ...
            self.transform_keys = ["layer1","layer2","layer3","layer4","conv","stats","bn1","bn2","fc1", "fc2"]
    ...
    def forward(self, x):
        ...
        out = self.bn_stats(self.stats(out))
        ...
        out = self.auto(self.tail_dropout, out)
