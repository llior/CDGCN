...
class Xvector(TopVirtualNnet):
    ...
    def init(self, inputs_dim, num_targets, extend=False, skip_connection=False, 
        ...
        self.se2 = SEBlock(512, ratio=se_ratio*2) if SE else None

        self.tdnn3 = ReluBatchNormTdnnLayer(512,512,[-3,0,3], **tdnn_layer_params)
        self.se3 = SEBlock(512, ratio=se_ratio*2) if SE else None
        ...
        if training :
            ...
            self.transform_keys = ["tdnn1","tdnn2","tdnn3","tdnn4","tdnn5","stats",
